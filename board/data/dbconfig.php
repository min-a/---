...
define('G5_MYSQL_USER', 'januber');
define('G5_MYSQL_PASSWORD', 'januber9972');
define('G5_MYSQL_DB', 'januber');
...
//테이블 추가
$product['category_table'] = G5_TABLE_PREFIX.'category';	//제품관리_카테고리 테이블
$product['list_table'] = G5_TABLE_PREFIX.'list';	//제품목록 테이블
$product['pds_table'] = G5_TABLE_PREFIX.'list_pds';	//제품목록 테이블
?>